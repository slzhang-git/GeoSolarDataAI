...
This area is of 16,078,514.69 square meters in total, with 2,828 buildings, and the area covered by buildings is 872,602.83 square meters. We run the solar detection first, and then we go through a minor mannual cleaning for the detected result to avoid the visualization of detection errors. The detected solar panels are visualized below, with the visualization in an [interactive map here](https://slzhang-git.github.io/GeoSolarDataAI/City_town_level_detection/Cleaned_%20Bülach_Switzerland20260426.html)
